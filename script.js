document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('JSON/categories.json')
        ...
        .catch(err => {
            ...
            document.getElementById('games-category-select').innerHTML = '<option value="All">Error Loading Categories</option>';
            document.getElementById('apps-category-select').innerHTML = '<option value="All">Error Loading Categories</option>';
        });
